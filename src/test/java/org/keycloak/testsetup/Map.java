...
import org.keycloak.models.map.client.FileClientProviderFactory;
import org.keycloak.models.map.clientscope.FileClientScopeProviderFactory;
import org.keycloak.models.map.group.FileGroupProviderFactory;
import org.keycloak.models.map.realm.FileRealmProviderFactory;
import org.keycloak.models.map.role.FileRoleProviderFactory;
...
import org.keycloak.storage.BaDatastoreProviderFactory;
...
public class Map extends KeycloakModelParameters {
    ...
    static final Set<Class<? extends ProviderFactory>> ALLOWED_FACTORIES =
            ImmutableSet.<Class<? extends ProviderFactory>>builder()
                    ...
                    .add(BaDatastoreProviderFactory.class)
                    .build();
