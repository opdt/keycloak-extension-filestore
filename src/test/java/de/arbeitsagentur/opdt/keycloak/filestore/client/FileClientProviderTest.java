...
class FileClientProviderTest extends KeycloakModelTest {
  ...
  void whenSearchClientsByClientIdStream_givenNoClients_thenReturnEmptyStream() {
    withRealmAndProvider(
        ...
        (clients, realm) -> {
          ...
          // Act
          Stream<ClientModel> actual =
              clients.searchClientsByClientIdStream(realm, "pattern", null, null);
          // Assert
          assertThat(actual).isEmpty();
        });
  }
  ...
  void whenSearchClientsByClientIdStream_givenNullParam_thenReturnEmptyStream() {
    withRealmAndProvider(
        ...
        (clients, realm) -> {
          // Act
          Stream<ClientModel> actual =
              clients.searchClientsByClientIdStream(realm, null, null, null);
          // Assert
          assertThat(actual).isEmpty();
        });
  }
  ...
  void whenSearchClientsByClientIdStream_givenResultLimits_thenReturnStream() {
    withRealmAndProvider(
        ...
        (clients, realm) -> {
          ...
          // Act
          Stream<ClientModel> actual =
              clients.searchClientsByClientIdStream(realm, "pattern", 1, 2);
          // Assert
          assertThat(actual)
              .hasSize(2)
              .map(ClientModel::getClientId)
  ...
  void whenSearchClientsByClientIdStream_givenOutOfBoundLimits_thenReturnEmptyStream() {
    withRealmAndProvider(
        ...
        (clients, realm) -> {
          ...
          // Act
          Stream<ClientModel> actual =
              clients.searchClientsByClientIdStream(realm, "pattern", 5, 10);
          // Assert
          assertThat(actual).isEmpty();
        });
  }
  ...
  void whenSearchClientsByAttributes_givenNoClients_thenReturnEmptyStream() {
    withRealmAndProvider(
        ...
        (clients, realm) -> {
          Stream<ClientModel> actual =
              clients.searchClientsByAttributes(realm, Map.of(), null, null);
          assertThat(actual).isEmpty();
        });
  }
  ...
  void whenSearchClientsByAttributes_givenNoMatch_thenReturnEmptyStream() {
    withRealmAndProvider(
        ...
        (clients, realm) -> {
          ...
          // Act
          Stream<ClientModel> actual =
              clients.searchClientsByAttributes(realm, Map.of("match", "val"), null, null);
          // Assert
          assertThat(actual).isEmpty();
        });
  }
  ...
  void whenSearchClientsByAttributes_givenMultipleSearchAttrs_thenReturnStream() {
    withRealmAndProvider(
        ...
        (clients, realm) -> {
          ...
          Stream<ClientModel> actual =
              clients.searchClientsByAttributes(realm, searchMap, null, null);
          // Assert
  ...
  void whenAddClientScopes_givenClientScopes_thenNoExceptionIsThrown() {
    withRealm(
        ...
        (session, realm) -> {
          ...
          var cs2 =
              session.clientScopes().addClientScope(realm, "clientScope-with-unknown-protocol");
          cs2.setProtocol("unknown protocol");
          // Act
          session.clients().addClientScopes(realm, client, Set.of(cs1, cs2), false);
          // Assert
          Map<String, ClientScopeModel> actual =
              session.clients().getClientScopes(realm, client, false);
