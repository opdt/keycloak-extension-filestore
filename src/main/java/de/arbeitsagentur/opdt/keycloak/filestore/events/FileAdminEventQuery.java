            ...
            .filter(
                ev ->
                    this.operationTypes == null
                        || ev.getOperationType() != null
                            && this.operationTypes.contains(ev.getOperationType()))
            .filter(
                ev ->
                    this.resourceTypes == null
                        || ev.getResourceType() != null
                            && this.resourceTypes.contains(ev.getResourceType()))
            .filter(
                ev ->
                    this.resourcePath == null
                        || (ev.getResourceType() != null
                            && SearchPatterns.like(
                                ev.getResourcePath(), this.resourcePath.replace('*', '%'))))
