...
public class FileRealmAdapter extends AbstractRealmModel<FileRealmEntity> implements RealmModel {
  ...
  public void updateRequiredCredentials(Set<String> credentials) {
    Set<FileRequiredCredentialEntity> requiredCredentialEntities =
        new HashSet<>(entity.getRequiredCredentials());
    Consumer<FileRequiredCredentialEntity> updateCredentialFnc =
        e -> {
          Optional<FileRequiredCredentialEntity> existingEntity =
              requiredCredentialEntities.stream()
  ...
  public AuthenticationFlowModel addAuthenticationFlow(AuthenticationFlowModel model) {
    ...
    FileAuthenticationFlowEntity authenticationFlowEntity =
        FileAuthenticationFlowEntity.fromModel(model);
  ...
  public void updateAuthenticationFlow(AuthenticationFlowModel model) {
    entity
        .getAuthenticationFlow(model.getId())
        .ifPresent(
            existing -> {
  ...
  public Stream<AuthenticationExecutionModel> getAuthenticationExecutionsStream(String flowId) {
    Set<FileAuthenticationExecutionEntity> aee =
        new HashSet<>(entity.getAuthenticationExecutions());
    return aee == null
        ? Stream.empty()
        : aee.stream()
  ...
  public AuthenticationExecutionModel addAuthenticatorExecution(
    ...
    FileAuthenticationExecutionEntity executionEntity =
        FileAuthenticationExecutionEntity.fromModel(model);
  ...
  public void updateAuthenticatorExecution(AuthenticationExecutionModel model) {
    entity
        .getAuthenticationExecution(model.getId())
        .ifPresent(
            existing -> {
  ...
  public AuthenticatorConfigModel addAuthenticatorConfig(AuthenticatorConfigModel model) {
    ...
    FileAuthenticatorConfigEntity authenticatorConfig =
        FileAuthenticatorConfigEntity.fromModel(model);
  ...
  public void updateAuthenticatorConfig(AuthenticatorConfigModel model) {
    entity
        .getAuthenticatorConfig(model.getId())
        .ifPresent(
            oldAC -> {
  ...
  public void updateRequiredActionConfig(RequiredActionConfigModel model) {
    entity
        .getRequiredActionConfig(model.getId())
        .ifPresent(
            oldAC -> {
              oldAC.setAlias(model.getAlias());
  ...
  public RequiredActionProviderModel addRequiredActionProvider(RequiredActionProviderModel model) {
    ...
    FileRequiredActionProviderEntity requiredActionProvider =
        FileRequiredActionProviderEntity.fromModel(model);
  ...
  public void updateRequiredActionProvider(RequiredActionProviderModel model) {
    entity
        .getRequiredActionProvider(model.getId())
        .ifPresent(
            oldRAP -> {
  ...
  public Stream<IdentityProviderModel> getIdentityProvidersStream() {
    ...
    return ips == null
        ...
        : ips.stream()
            .map(
                e ->
                    FileIdentityProviderEntity.toModel(
  ...
  private IdentityProviderModel getModelFromProviderFactory(String providerId) {
    Optional<IdentityProviderFactory> factory =
        Stream.concat(
                session
                    .getKeycloakSessionFactory()
                    .getProviderFactoriesStream(IdentityProvider.class),
                session
                    .getKeycloakSessionFactory()
  ...
  public void removeIdentityProviderByAlias(String alias) {
    ...
    session
        .getKeycloakSessionFactory()
        .publish(
            new IdentityProviderRemovedEvent() {
  ...
  public Stream<IdentityProviderMapperModel> getIdentityProviderMappersStream() {
    ...
    return ipms == null
        ? Stream.empty()
        : ipms.stream().map(FileIdentityProviderMapperEntity::toModel);
  }
  ...
  public IdentityProviderMapperModel addIdentityProviderMapper(IdentityProviderMapperModel model) {
    FileIdentityProviderMapperEntity identityProviderMapper =
        FileIdentityProviderMapperEntity.fromModel(model);
  ...
  public void updateIdentityProviderMapper(IdentityProviderMapperModel model) {
    entity
        .getIdentityProviderMapper(model.getId())
        .ifPresent(
            oldIPM -> {
  ...
  private static final String COMPONENT_PROVIDER_EXISTS_DISABLED =
      "component.provider.exists.disabled";
  ...
  public ComponentModel importComponentModel(ComponentModel model) {
    ...
    if (model.getId() != null && entity.getComponent(model.getId()).isPresent()) {
      LOG.warn(
          "Removing existing component with ID " + model.getId() + " since it already exists.");
  ...
  public void removeComponents(String parentId) {
    ...
    components.stream()
        ...
        .collect(
            Collectors
                .toSet()) // This is necessary to read out all the components before removing them
        .forEach(
            c -> {
  ...
  public Stream<ComponentModel> getComponentsStream() {
    ...
    return components == null
        ? Stream.empty()
        : components.stream().map(FileComponentEntity::toModel);
  }
  ...
  public int getNotBefore() {
    ...
    return notBefore == null
        ? 0
        : TimeAdapter.fromLongWithTimeInSecondsToIntegerWithTimeInSeconds(notBefore);
  }
  ...
  public Stream<ClientInitialAccessModel> getClientInitialAccesses() {
    ...
    return cias == null
        ? Stream.empty()
        : cias.stream().map(FileClientInitialAccessEntity::toModel);
  }

  @Override
  public void decreaseRemainingCount(ClientInitialAccessModel model) {
    entity
        .getClientInitialAccess(model.getId())
