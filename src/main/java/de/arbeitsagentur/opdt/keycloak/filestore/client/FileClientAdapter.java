...
public abstract class FileClientAdapter extends AbstractClientModel<FileClientEntity>
  ...
  public void setProtocol(String protocol) {
    if (!Objects.equals(entity.getProtocol(), protocol)) {
      ...
      session
          ...
          .publish((ClientProtocolUpdatedEvent) () -> FileClientAdapter.this);
    }
  }
  ...
  public Map<String, String> getAuthenticationFlowBindingOverrides() {
    ...
    return authenticationFlowBindingOverrides == null
  ...
  public Stream<ProtocolMapperModel> getProtocolMappersStream() {
    final Set<FileProtocolMapperEntity> protocolMappers =
        new HashSet<>(entity.getProtocolMappers());
