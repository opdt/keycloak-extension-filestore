...
public class EventUtils {
  ...
  public static FileAdminEventEntity modelToEntity(
      AdminEvent adminEvent, boolean includeRepresentation) {
  ...
  private static void setAuthDetails(
      FileAdminEventEntity adminEventEntity, AuthDetails authDetails) {
