...
public class FileIdentityProviderEntity implements AbstractEntity, UpdatableEntity {
  ...
  static FileIdentityProviderEntity fromModel(IdentityProviderModel model) {
    ...
    String id =
        model.getInternalId() == null ? KeycloakModelUtils.generateId() : model.getInternalId();
    entity.setId(id);
  ...
  static IdentityProviderModel toModel(
    ...
    model.setAddReadTokenRoleOnCreate(
        addReadTokenRoleOnCreate == null ? false : addReadTokenRoleOnCreate);
