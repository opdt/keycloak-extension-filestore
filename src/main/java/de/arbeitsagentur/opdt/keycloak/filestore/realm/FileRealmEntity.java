...
public class FileRealmEntity implements AbstractEntity, UpdatableEntity {
    ...
    public boolean isUpdated() {
        return this.isUpdated
                || Optional.ofNullable(getAuthenticationExecutions()).orElseGet(Collections::emptyList).stream()
                ...
                || Optional.ofNullable(getClientInitialAccesses()).orElseGet(Collections::emptyList).stream()
                ...
                || Optional.ofNullable(getIdentityProviderMappers()).orElseGet(Collections::emptyList).stream()
                        .anyMatch(FileIdentityProviderMapperEntity::isUpdated)
                || Optional.ofNullable(getRequiredActionProviders()).orElseGet(Collections::emptyList).stream()
                ...
                || Optional.ofNullable(getOtpPolicy())
                        .map(FileOTPPolicyEntity::isUpdated)
                        .orElse(false)
    ...
    public Optional<FileAuthenticationFlowEntity> getAuthenticationFlow(String flowId) {
        return this.authenticationFlows.stream()
    ...
    public Optional<FileAuthenticationExecutionEntity> getAuthenticationExecution(String id) {
        return this.authenticationExecutions.stream()
    ...
    public Optional<FileRequiredActionConfigEntity> getRequiredActionConfig(String id) {
        return this.requiredActionConfigs.stream()
