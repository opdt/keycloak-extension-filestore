...
import static org.keycloak.models.map.common.AbstractFileProviderFactory.MapProviderObjectType.CLIENT_AFTER_REMOVE;
import static org.keycloak.models.map.common.AbstractFileProviderFactory.MapProviderObjectType.CLIENT_BEFORE_REMOVE;
...
public class FileClientProvider implements ClientProvider {
    ...
    public FileClientProvider(KeycloakSession session, ConcurrentMap<String, ConcurrentMap<String, Long>> clientRegisteredNodesStore) {
    ...
    /**
     * @deprecated Do not use, this is only to support a deprecated logout endpoint and will vanish with its removal
     */
